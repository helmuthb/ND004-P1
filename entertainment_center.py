...
def get_movie_list():
    ...
    movie_list.append(media.Movie(
        "Paper Towns",
        "Paper Towns is an upcoming American teen romantic mystery"
          " film, directed by Jake Schreier based on the 2008 novel"
          " of the same name by John Green.",
        "http://img09.deviantart.net/cbf5/i/2015/073/a/3/paper_towns"
          "__movie_poster__by_blantonl98-d8loztt.jpg",
        "https://www.youtube.com/watch?v=rFGiHm5WMLk",
        ["Nat Wolff", "Cara Delevingne"],
        2015))
    movie_list.append(media.Movie(
        "Lucifer",
        "Lucifer is an upcoming American television series that is"
          " set to air on Fox",
